...
function SubscriptionSkeleton() {
  return (
    <Card className="mb-8 h-[140px]">
      <CardHeader>
        <CardTitle>Team abonnement</CardTitle>
      </CardHeader>
    </Card>
  );
}
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            <div className="mb-4 sm:mb-0">
              <p className="font-medium">
                Huidig plan: {teamData?.planName || 'Gratis'}
              </p>
            ...
            <li key={member.id} className="flex items-center justify-between">
              ...
              {index > 1 ? (
                <form action={removeAction}>
                  ...
                  >
                    {isRemovePending ? 'Verwijderen...' : 'Verwijderen'}
                  </Button>
                </form>
              ) : null}
            </li>
  ...
  return (
    <Card>
      ...
      {!isOwner && (
        <CardFooter>
          <p className="text-sm text-muted-foreground">
            Je moet team-eigenaar zijn om nieuwe leden uit te nodigen.
          </p>
        </CardFooter>
      )}
    </Card>
...
export default function TeamPage() {
  return (
    <section className="flex-1 p-6 lg:p-8">
      <h1 className="text-2xl font-semibold text-gray-900 mb-6">Team instellingen</h1>
